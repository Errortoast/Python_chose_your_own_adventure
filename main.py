...
def updateButtons(numButtons):
    ...
    if (numButtons>3): option4.pack(padx=20, pady=20);
    if (numButtons>4): option5.pack(padx=20, pady=20);

def nextOption():
    global currentLine, option1Text, option2Text, option3Text, option4Text, option5Text, option1line, option2line, option3line, option4line, option5line, question;
    try:
